        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            try
            {
                ...
                {
                    Console.WriteLine("Please only enter number from 1 to 100!");
                }
            } // end of try
            catch
            {
                Console.WriteLine("Your input was invalid. Please only enter number from 1 to 100!");
            } // end of catch

            // Instruct user to close the window
            Console.WriteLine("Now press any key to exit and come back any time to play again.");
